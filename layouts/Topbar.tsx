...
const Topbar = ({
  ...
  return (
    <React.Fragment>
      <div className={`navbar-custom ${navbarCssClasses}`} style={{ backgroundColor: "#006daf" }}>
        <div className={`topbar ${containerCssClasses}`}>
          ...
          <ul className="topbar-menu d-flex align-items-center">
            ...
            <li>
              <button
                className="nav-link dropdown-toggle right-bar-toggle waves-effect waves-light btn btn-link shadow-none" style={{ backgroundColor: "#006daf" }}
