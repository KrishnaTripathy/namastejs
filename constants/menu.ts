...
const MENU_ITEMS: MenuItemTypes[] = [
    ...
    children: [
      {
        ...
        url: "/admin/Chief-Complaints",
        parentKey: "apps-email",
      },
      {
        key: "physical-comorbidities",
        label: "Physical comorbidities",
        url: "/admin/physical-comorbodities",
        parentKey: "apps-email",
      },
      {
  ...
  },
  {
    ...
    isTitle: false,
    icon: "user",
    url: "/anc/staff/profile",
  },

  { key: "custom", label: "Patient Dashboard", isTitle: true },
  {
    key: "extra-pages",
    label: "Dashboards",
    isTitle: false,
    ...
    children: [
      {
        key: "page-starter",
        label: "Dashboard",
        url: "/patient/dashboard-1",
        parentKey: "extra-pages",
      },
      {
        key: "page-timeline",
        label: "Appointment",
        url: "/patient/dashboard-8",
        parentKey: "extra-pages",
      },
      {
        key: "page-sitemap",
        label: "Procedures",
        url: "/patient/dashboard-5",
        parentKey: "extra-pages",
      },
      {
        key: "page-invoice",
        label: "Prescriptions",
        url: "/patient/dashboard-6",
        parentKey: "extra-pages",
      },
      {
        key: "page-faq",
        label: "Billing",
        url: "/patient/dashboard-7",
        parentKey: "extra-pages",
      },
      {
        key: "page-search-result",
        label: "Profile",
        url: "/patient/dashboard-4",
        parentKey: "extra-pages",
      },
      {
        key: "ds-dashboard-5",
  ...
  { key: "components", label: "Doctor DashBoard", isTitle: true },
  {
    key: "base-ui-buttons",
    label: "DashBoard",
  ...
  { key: "components", label: "Receptionist DashBoard", isTitle: true },
  {
    key: "base-ui-buttons",
    label: "DashBoard",
...
const PATIENT_MENU_ITEMS: MenuItemTypes[] = [
  {
    key: "extra-pages",
    label: "Dashboards",
    isTitle: false,
...
const DOCTOR_MENU_ITEMS: MenuItemTypes[] = [
...
const HORIZONTAL_MENU_ITEMS: MenuItemTypes[] = [
  {
    ...
    children: [
      ...
      },
      {
        key: "ds-dashboard-2",
        label: "Dashboard 2",
        url: "/patient/dashboard-2",
        parentKey: "dashboard",
      },
      {
        key: "ds-admin-dashboard",
        label: "Dashboard 3",
        url: "/admin-dashboard",
        parentKey: "dashboard",
      },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            url: "/admin/procedure/details",
            parentKey: "apps-ecommerce",
          },
          {
            key: "ecommerce-edit-product",
            label: "Add Product",
            url: "/admin/procedure/edit",
            parentKey: "apps-ecommerce",
          },
          {
...
export { MENU_ITEMS,PATIENT_MENU_ITEMS, TWO_COl_MENU_ITEMS, DOCTOR_MENU_ITEMS, HORIZONTAL_MENU_ITEMS, };
