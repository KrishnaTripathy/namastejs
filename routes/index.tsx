...
// import Dashboard6 from '../pages/dashboard/Dashboard6/index';
...
const BasePage = React.lazy(() => import("../pages/auth/BasePage"));
...
const Dashboard5 = React.lazy(() => import("../pages/dashboard/Dashboard5/"));
const Dashboard6 = React.lazy(() => import("../pages/dashboard/Dashboard6/"));
const Dashboard7 = React.lazy(() => import("../pages/dashboard/Dashboard7/"));
const Dashboard8 = React.lazy(() => import("../pages/dashboard/Dashboard8"));

//Profile
const StaffProfile = React.lazy(() => import("../pages/apps/Profile"));

//Doctor Panel
const DoctorDashboard = React.lazy(() => import("../pages/doctors/Dashboard"));
const PatientList = React.lazy(() => import('../pages/doctors/Patient'));
const DoctorConsultation = React.lazy(() => import("../pages/doctors/Consultation"));
const Prescription = React.lazy(() => import("../pages/doctors/Prescribe"));
const PatientDetails = React.lazy(() => import("../pages/doctors/PatientDetails"));


//Receptionist Panel
const ReceptionistDashbord = React.lazy(() => import("../pages/receptionist/dashboard"));
const ReceptionistPatientList = React.lazy(() => import("../pages/receptionist/patient"))
const ReceptionistPatientDetails = React.lazy(() => import("../pages/receptionist/PatientDetails"))
const PatientBill = React.lazy(() => import("../pages/receptionist/billing"))
const PatientBillInvoice = React.lazy(() => import("../pages/receptionist/billing/Invoice"));
...
const ChiefComplaints = React.lazy(() => import("../pages/apps/CRM/Complaints/ChiefComplaints"));
const PhysicalComorbodities = React.lazy(() => import("../pages/apps/CRM/Comorbodities/PhysicalComorbodities"));
const Symptoms = React.lazy(() => import("../pages/apps/CRM/Syptoms/Symptoms"));
const Assessments = React.lazy(() => import("../pages/apps/CRM/Assessments/Assessments"));
...
const MedicationData = React.lazy(() => import("../pages/apps/CRM/Contacts/MedicationData"))
// - email
...
// const PatientProcedure = React.lazy(() => import("../pages/error/PatientProcedure"));
...
const dashboardRoutes: RoutesProps = {
  ...
  children: [
    ...
    {
      path: "/patient/dashboard-1",
      name: "Dashboard 1",
      element: <Dashboard1 />,
      route: PrivateRoute,
    },
    {
      path: "/patient/dashboard-2",
      name: "Dashboard 2",
      element: <Dashboard2 />,
      route: PrivateRoute,
    },
    ...
    {
      path: "/patient/dashboard-4",
      name: "Dashboard 4",
      element: <Dashboard4 />,
      route: PrivateRoute,
    },
    {
      path: "/patient/dashboard-5",
      name: "Dashboard 5",
      element: <Dashboard5 />,
      route: PrivateRoute,
    },
    {
      path: "/patient/dashboard-6",
      name: "Dashboard 6",
      element: <Dashboard6 />,
      route: PrivateRoute,
    },
    {
      path: "/patient/dashboard-7",
      name: "Dashboard 7",
      element: <Dashboard7 />,
      route: PrivateRoute,
    },
    {
      path: "/patient/dashboard-8",
      name: "Dashboard 8",
      element: <Dashboard8 />,
      route: PrivateRoute,
    },
...
const DoctorDashboardRoutes: RoutesProps = {
...
const crmAppRoutes = {
  ...
  children: [
    ...
    {
      path: "/anc/hospital/add-hospital",
      name: "Opportunities",
    ...
    {
      path: "/admin/Medication-data",
      name: "Medication",
      element: <MedicationData medicalDetails={[]} />,
      route: PrivateRoute,
    },
    {
      path: "/admin/Chief-Complaints",
      name: "Chief Complaints",
      element: <ChiefComplaints complaints={[]} />,
      route: PrivateRoute,
    },
    {
      path: "/admin/physical-comorbodities",
      name: "Physical Comorbodities",
      element: <PhysicalComorbodities comorbodities={[]} />,
      route: PrivateRoute,
    },
    {
      path: "/admin/symptoms",
...
// this contain the route of staff
const uiRoutes = {
  path: "/ui",
  name: "Components",
  icon: "pocket",
  ...
  children: [
    {
      ...
      children: [
        ...
        {
          path: "/doctor/consultaion",
          name: "Doctor Consultation",
          route: PrivateRoute,
          element: <DoctorConsultation />
        },
        {         
          path: "/doctor/new-consultation",
        ...
        {
          path: "/receptionist/patient-list",
          name: "Patient List",
          route: PrivateRoute,
        ...
        {
          path: "/patient/bill/invoice",
          name: "Patient Bill Invoice",
          route: PrivateRoute,
          element: <PatientBillInvoice />
        },
        {
          path: "/ui/cards",
          name: "Cards",
